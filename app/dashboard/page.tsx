...
export default function DashboardPage() {
  ...
  const handleStartEvaluation = async () => {
    ...
    console.log("[v0] Starting evaluation for PayPal:", userData.paypal)
    ...
    try {
      ...
      console.log("[v0] PayPal API response:", data)

      if (response.ok) {
        setPayoutMessage({
          type: "success",
          text: `Payment of $0.01 sent successfully to your PayPal! (${data.mode} mode)`,
        })
        ...
        const errorMessage = data.details
          ...
          : data.error || "Failed to send payment. Please try again."

        console.error("[v0] PayPal error details:", data)
